...
import sync.composeapp.generated.resources.desktop_webview_description
import sync.composeapp.generated.resources.open_blog_post
...
actual fun PlatformWebView(
    ...
    Box(
        ...
        Column(
            ...
            Button(
                onClick = {
                    openUrl("https://www.sync.org/blogs/en/how-to-log-in-on-desktop-app")
                },
            ) {
                Text(
...
actual fun DiscordWebView(
    ...
    Box(
        ...
        Column(
            ...
            Button(
                onClick = {
                    openUrl("https://www.sync.org/blogs/en/how-to-log-in-to-Discord-on-desktop-app")
                },
            ) {
                Text(
                    stringResource(Res.string.open_blog_post),
