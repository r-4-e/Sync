package com.flyn.sync.ui.screen.login
...
import com.flyn.sync.expect.ui.PlatformWebView
import com.flyn.sync.expect.ui.createWebViewCookieManager
import com.flyn.sync.expect.ui.rememberWebViewState
import com.flyn.sync.ui.component.DevLogInBottomSheet
import com.flyn.sync.ui.component.DevLogInType
...
import sync.composeapp.generated.resources.log_in
import sync.composeapp.generated.resources.login_failed
import sync.composeapp.generated.resources.login_success
    ...
    LaunchedEffect(state) {
        snapshotFlow { state.value }.collect {
            Logger.d(
                ...
                "WebViewState: ${
                    when (it) {
                        is com.flyn.sync.expect.ui.WebViewState.Finished -> "Finished"
                        is com.flyn.sync.expect.ui.WebViewState.Loading -> "Loading ${it.progress}%"
                    }
                }",
            )
        }
