...
/**
 * Thin entry point for Sync Desktop.
 *
 ...
 */
/**
 * Force the X11 WM_CLASS so the Linux taskbar/dock shows "Sync" instead of
 ...
 */
private fun forceLinuxWmClass(appName: String = "Sync") {
