# CLAUDE.md - Sync Project Guide for AI Agents
...
**Sync** is a FOSS (Free and Open Source Software) YouTube Music client for Android and Desktop, built with Compose Multiplatform.
...
- **lyricsService/**: Lyrics fetching (LRCLIB, Sync Lyrics, BetterLyrics)
...
- **Features**:
  - Deep link support (`sync://` and `sync.org`)
...
**Location**: `core/media/media-jvm/src/main/java/com/sync/media_jvm/VlcPlayerAdapter.kt`
...
**Location**: `core/media/media3/src/main/java/com/Flyn/media3/exoplayer/CrossfadeExoPlayerAdapter.kt`
...
### Translation
- Use Crowdin: https://crowdin.com/project/sync
...
- **Sync Chart**: Chart playlists integrated into Library screen
...
- **Sync Lyrics voting**: Vote functionality for community lyrics

### New Features (post-1.0.4, dev branch)
- **Deep link support**: `sync://` and `sync.org` URL schemes
...
*This document helps AI Agents quickly understand the Sync project. Update regularly when there are major changes to architecture or structure.*

**Last updated**: 2026-03-14
**Project version**: Check latest release on GitHub
**Maintained by**: Flyn and contributors
