package com.flyn.sync.service.backup
...
import com.Flyn.common.DB_NAME
import com.Flyn.common.DOWNLOAD_EXOPLAYER_FOLDER
import com.Flyn.common.EXOPLAYER_DB_NAME
import com.Flyn.common.SETTINGS_FILENAME
...
class AutoBackupWorker(
    ...
    private fun saveToDownloads(backupFile: File): Boolean {
        ...
        val fileName = "sync_backup_$timestamp.zip"
        ...
        return try {
            val contentValues = ContentValues().apply {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                    put(MediaStore.Downloads.RELATIVE_PATH, "Download/Sync")
                }
            }
            ...
            uri?.let { outputUri ->
                ...
                Logger.i(TAG, "Backup saved to Downloads/Sync/$fileName")
                true
            } ?: false
        } catch (e: Exception) {
    ...
    private fun cleanupOldBackups(maxFiles: Int) {
        try {
            ...
            val selectionArgs = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                arrayOf("Download/Sync/", "sync_backup_%.zip")
            } else {
                arrayOf("sync_backup_%.zip")
            }
            ...
            context.contentResolver.query(
                ...
                while (cursor.moveToNext()) {
                    ...
                    if (name.startsWith("sync_backup_") && name.endsWith(".zip")) {
