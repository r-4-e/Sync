package com.flyn.sync.service.rss
...
import com.Flyn.domain.extension.epochMillisToLocalDateTime
import com.Flyn.domain.extension.now
import com.Flyn.domain.repository.CommonRepository
import com.Flyn.logger.Logger
import com.flyn.sync.service.test.notification.NotificationHandler
...
class RssFeedNotifyWork(
    ...
    private fun fetchFeed(urlStr: String): String {
        val connection =
            (URL(urlStr).openConnection() as HttpURLConnection).apply {
                ...
                readTimeout = 15_000
                requestMethod = "GET"
                setRequestProperty("User-Agent", "Sync")
            }
        return try {
    ...
    companion object {
        ...
        const val FEED_URL = "https://www.Flyn.dev/rss.xml"
